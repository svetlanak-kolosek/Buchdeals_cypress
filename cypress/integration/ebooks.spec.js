...
describe ("Ebooks", ()=>{
    ...
    it("Ebooks categories - 'Kostenlose Ebook Deals' - should contain", ()=>{
    ...
    it("Ebooks categories - 'Krimis' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Thriller' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Abenteuer' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Liebesromane' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Science Fiction' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Historische Romane' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Gesundheit, Körper und Geist' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Fantasy' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Belletristik' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Sachbuch' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Bestseller' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
    ...
    it("Ebooks categories - 'Bestseller auf Englisch' - should contain", ()=>{
        cy.login(emailOrdUser, password)
        cy.get(Locators.Login.Message).should("be.visible").and("include.text", alertSuccess)
        cy.url().should("contains", "https://staging.buchdeals.de/ebooks")
        cy.get(Locators.Ebooks.DE).eq(0).click()
